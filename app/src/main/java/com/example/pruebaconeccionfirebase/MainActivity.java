...
package com.example.pruebaconeccionfirebase;
...
import com.example.pruebaconeccionfirebase.Adaptadores.ListViewPersonasAdapter;
import com.example.pruebaconeccionfirebase.Models.Persona;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void insertar(){
        ...
        btnInsertar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                }else if(telefono.isEmpty() || telefono.length() <2 ){
                    showError(mInputTelefono, "Debes Escribir Activa o Inactiva");
                }else{
                    Persona p = new Persona();
    ...
    public boolean validarInputs(){
        ...
        if(nombre.isEmpty() || nombre.length() < 3){
            ...
            return true;
        }else if(telefono.isEmpty() || telefono.length() < 1){
            showError(inputTelefono, "Debes Escribir Activa o Inactiva");
            return true;
        }else{
            return false;
        }
